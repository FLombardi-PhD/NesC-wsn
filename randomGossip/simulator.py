...
def simula(nodes):
	...
	for i in range(0,4):
		...
		if nodes!=200:
			if MAXRIC==0: risultFPi.write(str(numero)+" ")
			elif MAXRIC==4: risultK4i.write(str(numero)+" ")
		...
		if nodes!=200:
			if MAXRIC==0: risultFPr.write(str(numero2)+" ")
			elif MAXRIC==4: risultK4r.write(str(numero2)+" ")
		...
		if nodes!=200:
			if MAXRIC==0: risultFPs.write(str(numero3)+" ")
			elif MAXRIC==4: risultK4s.write(str(numero3)+" ")
