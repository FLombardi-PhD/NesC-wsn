...
#apro il file che contiene la topologia generata da genTopo
f = open("topo.txt", "r")
...
#mac = t.mac()
#mac.setInitLow(20)      #setto l'initial backoff low
#mac.setInitHigh(5000)   #setto l'initial backoff high
#mac.setHigh(500)        #setto il backoff high
#mac.setLow(20)          #setto il backoff low
