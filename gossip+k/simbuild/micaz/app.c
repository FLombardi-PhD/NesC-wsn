...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x40339438, const void *arg_0x403395d0);
#line 776
__extension__ 
#line 793
__extension__ 
...
#line 251
extern double erfc(double arg_0x40383320) __attribute((__nothrow__)) ;
...
unsigned int (*hashfunction)(void *arg_0x404d3320), 
int (*key_eq_fn)(void *arg_0x404d3768, void *arg_0x404d38e0));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x405fd010, int arg_0x405fd168);
static double RandomUniform(void );
...
typedef TMilli FloodingC$MilliTimer$precision_tag;
typedef uint16_t FloodingC$Seed$parameter;
...
static void FloodingC$AMControl$startDone(error_t error);
#line 117
static void FloodingC$AMControl$stopDone(error_t error);
# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
static void FloodingC$Boot$booted(void );
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void FloodingC$AMSend$sendDone(
#line 92
message_t * msg, 
...
static void FloodingC$MilliTimer$fired(void );
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
static void /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 85
message_t * msg, 
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t FloodingC$AMControl$start(void );
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t FloodingC$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
#line 95
static uint8_t FloodingC$Packet$maxPayloadLength(void );
# 41 "/opt/tinyos-2.1.1/tos/interfaces/Random.nc"
static uint16_t FloodingC$Random$rand16(void );
# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void FloodingC$MilliTimer$startOneShot(uint32_t dt);
# 21 "FloodingC.nc"
nx_uint16_t FloodingC$nodes[1000][200];
nx_uint16_t FloodingC$nodes2[1000][200];

message_t FloodingC$packet[1000];

uint16_t FloodingC$message[1000];



uint16_t FloodingC$i[1000];

float FloodingC$r[1000];
float FloodingC$PROBABILITY[1000];


static inline void FloodingC$Boot$booted(void );
#line 53
static inline void FloodingC$AMControl$startDone(error_t err);
...
static inline void FloodingC$AMControl$stopDone(error_t err);



static inline void FloodingC$MilliTimer$fired(void );
#line 95
static inline message_t *FloodingC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 180
static inline void FloodingC$AMSend$sendDone(message_t *bufPtr, error_t error);
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 56
message_t * msg, 
...
static void /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 147
message_t * amsg, 
...
static error_t /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t FloodingC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 69
...
# 41 "/opt/tinyos-2.1.1/tos/interfaces/Random.nc"
inline static uint16_t FloodingC$Random$rand16(void ){
#line 41
  unsigned short __nesc_result;
#line 41
...
# 115 "/opt/tinyos-2.1.1/tos/interfaces/Packet.nc"
inline static void * FloodingC$Packet$getPayload(message_t * msg, uint8_t len){
#line 115
  void *__nesc_result;
#line 115
...
#line 98
    {
      ...
      radio_count_msg_t *rcm2 = (radio_count_msg_t *)FloodingC$Packet$getPayload(&FloodingC$packet[sim_node()], (int )(void *)0);

      sim_log_debug(112U, "Ricevuti", "Ricevuto Pacchetto id=%hhu seq=%hhu message=%hhu\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), __nesc_ntoh_uint16(rcm->message.data));
      if (16 != 0) {
          if (__nesc_ntoh_uint16(rcm->id.data) != TOS_NODE_ID) {
              if (__nesc_ntoh_uint16(FloodingC$nodes[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data) == __nesc_ntoh_uint16(rcm->seq.data)) {
                  (__nesc_temp44 = FloodingC$nodes2[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data, __nesc_hton_uint16(__nesc_temp44, (__nesc_temp45 = __nesc_ntoh_uint16(__nesc_temp44) + 1)), __nesc_temp45);
                  if (__nesc_ntoh_uint16(FloodingC$nodes2[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data) < 16) {


                      FloodingC$r[sim_node()] = (float )FloodingC$Random$rand16() / 65536;
                      FloodingC$PROBABILITY[sim_node()] = (float )((40 + (float )200 / 10) / (float )200);

                      if (FloodingC$r[sim_node()] <= FloodingC$PROBABILITY[sim_node()] || (__nesc_ntoh_uint16(FloodingC$nodes2[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data) == 0 || __nesc_ntoh_uint16(FloodingC$nodes2[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data) == 1)) {

                          __nesc_hton_uint16(rcm2->id.data, __nesc_ntoh_uint16(rcm->id.data));
                          __nesc_hton_uint16(rcm2->seq.data, __nesc_ntoh_uint16(rcm->seq.data));
                          __nesc_hton_uint16(rcm2->message.data, __nesc_ntoh_uint16(rcm->message.data));
                          if (FloodingC$AMSend$send(AM_BROADCAST_ADDR, &FloodingC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
                              sim_log_debug(113U, "Inoltro", "Pacchetto inoltrato id=%hhu, seq=%hhu, prob=%f, rand=%f\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), FloodingC$PROBABILITY[sim_node()], FloodingC$r[sim_node()]);
                            }
                        }
                      else {
                        sim_log_debug(114U, "Scarti", "Pacchetto scartato id=%hhu, seq=%hhu, prob=%f, rand=%f\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), FloodingC$PROBABILITY[sim_node()], FloodingC$r[sim_node()]);
                        }
                    }
                  else {
#line 128
                    sim_log_debug(115U, "Scarti", "Pacchetto scartato id=%hhu, seq=%hhu, prob=%f, rand=%f\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), FloodingC$PROBABILITY[sim_node()], FloodingC$r[sim_node()]);
                    }
                }
              else {
#line 130
                if (__nesc_ntoh_uint16(FloodingC$nodes[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data) > __nesc_ntoh_uint16(rcm->seq.data)) {
#line 130
                  sim_log_debug(116U, "Scarti", "Pacchetto scartato id=%hhu, seq=%hhu, prob=%f, rand=%f\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), FloodingC$PROBABILITY[sim_node()], FloodingC$r[sim_node()]);
                  }
                else 
#line 131
                  {
                    __nesc_hton_uint16(FloodingC$nodes[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data, __nesc_ntoh_uint16(rcm->seq.data));
                    __nesc_hton_uint16(FloodingC$nodes2[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data, 0);
                    ...
                    if (FloodingC$r[sim_node()] <= FloodingC$PROBABILITY[sim_node()] || (__nesc_ntoh_uint16(FloodingC$nodes2[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data) == 0 || __nesc_ntoh_uint16(FloodingC$nodes2[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data) == 1)) {
                        ...
                        __nesc_hton_uint16(rcm2->message.data, __nesc_ntoh_uint16(rcm->message.data));
                        if (FloodingC$AMSend$send(AM_BROADCAST_ADDR, &FloodingC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
                            sim_log_debug(117U, "Inoltro", "Pacchetto inoltrato id=%hhu, seq=%hhu, prob=%f, rand=%f\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), FloodingC$PROBABILITY[sim_node()], FloodingC$r[sim_node()]);
                          }
                      }
                    else {
                      sim_log_debug(118U, "Scarti", "Pacchetto scartato id=%hhu, seq=%hhu, prob=%f, rand=%f\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), FloodingC$PROBABILITY[sim_node()], FloodingC$r[sim_node()]);
                      }
                  }
                }
            }
...
#line 153
        {
          ...
          if (FloodingC$r[sim_node()] <= FloodingC$PROBABILITY[sim_node()] || (__nesc_ntoh_uint16(FloodingC$nodes2[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data) == 0 || __nesc_ntoh_uint16(FloodingC$nodes2[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data) == 1)) {
              ...
              __nesc_hton_uint16(rcm2->message.data, __nesc_ntoh_uint16(rcm->message.data));
              if (FloodingC$AMSend$send(AM_BROADCAST_ADDR, &FloodingC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
                  sim_log_debug(119U, "Inoltro", "Pacchetto inoltrato id=%hhu, seq=%hhu, prob=%f, rand=%f\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), FloodingC$PROBABILITY[sim_node()], FloodingC$r[sim_node()]);
                }
            }
          else {
            sim_log_debug(120U, "Scarti", "Pacchetto scartato iid=%hhu, seq=%hhu, prob=%f, rand=%f\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), FloodingC$PROBABILITY[sim_node()], FloodingC$r[sim_node()]);
            }
        }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x40839158, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x40839158) {
#line 67
    case 6:
#line 67
      __nesc_result = FloodingC$Receive$receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x40839158, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
# 162 "/opt/tinyos-2.1.1/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$AMPacket$setType(message_t *amsg, am_id_t t)
#line 162
{
  tossim_header_t *header = TossimActiveMessageC$getHeader(amsg);
...
inline static void /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 151
...
#line 151
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x408f59f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x408f59f8, addr, msg, len);
#line 69
...
#line 83
{
  ...
  sim_log_debug(121U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(122U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(123U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(124U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}

# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
#line 64
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x40834c70, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x40834c70, msg, error);
#line 99
}
#line 99
...
# 169 "/opt/tinyos-2.1.1/tos/lib/tossim/TossimActiveMessageC.nc"
static inline uint8_t TossimActiveMessageC$Packet$payloadLength(message_t *msg)
#line 169
{
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x408397f0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x408397f0, msg, payload, len);
#line 67
...
#line 180
{
  ...
  if (&FloodingC$packet[sim_node()] == bufPtr) {
    }
}

# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 99
  FloodingC$AMSend$sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x408f5010, message_t * msg, error_t error){
#line 89
  switch (arg_0x408f5010) {
#line 89
    case 0U:
#line 89
      /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x408f5010, msg, error);
#line 89
      break;
#line 89
    }
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t FloodingC$AMControl$start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void FloodingC$MilliTimer$startOneShot(uint32_t dt){
#line 62
...
{
  if (err == SUCCESS) {
      FloodingC$MilliTimer$startOneShot(500);
    }
  else {
      FloodingC$AMControl$start();
    }
}
...
#line 92
  FloodingC$AMControl$startDone(error);
#line 92
}
#line 92
# 88 "/opt/tinyos-2.1.1/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 117
  FloodingC$AMControl$stopDone(error);
#line 117
}
#line 117
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x40303ce0){
#line 64
  switch (arg_0x40303ce0) {
#line 64
...
#line 64
    default:
#line 64
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x40303ce0);
#line 64
      break;
#line 64
    }
...
inline static uint8_t FloodingC$Packet$maxPayloadLength(void ){
#line 95
  unsigned char __nesc_result;
#line 95
...
#line 68
  radio_count_msg_t *rcm = (radio_count_msg_t *)FloodingC$Packet$getPayload(&FloodingC$packet[sim_node()], (int )(void *)0);



  (__nesc_temp42 = FloodingC$nodes[sim_node()][TOS_NODE_ID].data, __nesc_hton_uint16(__nesc_temp42, (__nesc_temp43 = __nesc_ntoh_uint16(__nesc_temp42)) + 1), __nesc_temp43);


  if (FloodingC$Packet$maxPayloadLength() < sizeof(radio_count_msg_t )) {
      sim_log_debug(110U, "GossipBCastC", "size problem\n");
      return;
    }


  __nesc_hton_uint16(rcm->message.data, FloodingC$message[sim_node()]);
  __nesc_hton_uint16(rcm->id.data, TOS_NODE_ID);
  __nesc_hton_uint16(rcm->seq.data, __nesc_ntoh_uint16(FloodingC$nodes[sim_node()][TOS_NODE_ID].data));


  if (TOS_NODE_ID == 1) {
      if (FloodingC$AMSend$send(AM_BROADCAST_ADDR, &FloodingC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
          sim_log_debug(111U, "Inoltro", "Pacchetto inviato id=%hhu seq=%hhu message=%hhu\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), __nesc_ntoh_uint16(rcm->message.data));
        }
    }
}
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b463a8){
#line 72
  switch (arg_0x40b463a8) {
#line 72
    case 0U:
#line 72
      FloodingC$MilliTimer$fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b463a8);
#line 72
      break;
#line 72
    }
...
#line 36
{
  ...
  sim_log_debug(109U, "Boot", "Node %hhu booted\n", TOS_NODE_ID);
  FloodingC$AMControl$start();
  for (FloodingC$i[sim_node()] = 0; FloodingC$i[sim_node()] < 200; ++FloodingC$i[sim_node()]) {
      __nesc_hton_uint16(FloodingC$nodes[sim_node()][FloodingC$i[sim_node()]].data, 0);
    }
}
...
#line 47
{
  /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*FloodingAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module FloodingC */
  if (!strcmp(varname, "FloodingC$nodes"))
  {
    *addr = (uintptr_t)&FloodingC$nodes[__nesc_mote];
    *size = sizeof(FloodingC$nodes[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingC$nodes2"))
  {
    *addr = (uintptr_t)&FloodingC$nodes2[__nesc_mote];
    *size = sizeof(FloodingC$nodes2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingC$packet"))
  {
    *addr = (uintptr_t)&FloodingC$packet[__nesc_mote];
    *size = sizeof(FloodingC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingC$message"))
  {
    *addr = (uintptr_t)&FloodingC$message[__nesc_mote];
    *size = sizeof(FloodingC$message[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "FloodingC$r"))
  {
    *addr = (uintptr_t)&FloodingC$r[__nesc_mote];
    *size = sizeof(FloodingC$r[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingC$PROBABILITY"))
  {
    *addr = (uintptr_t)&FloodingC$PROBABILITY[__nesc_mote];
    *size = sizeof(FloodingC$PROBABILITY[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module FloodingC */
  memset((void *)&FloodingC$nodes[__nesc_mote], 0, sizeof FloodingC$nodes[__nesc_mote]);
  memset((void *)&FloodingC$nodes2[__nesc_mote], 0, sizeof FloodingC$nodes2[__nesc_mote]);
  memset((void *)&FloodingC$packet[__nesc_mote], 0, sizeof FloodingC$packet[__nesc_mote]);
  FloodingC$message[__nesc_mote] = 0;
  memset((void *)&FloodingC$i[__nesc_mote], 0, sizeof FloodingC$i[__nesc_mote]);
  memset((void *)&FloodingC$r[__nesc_mote], 0, sizeof FloodingC$r[__nesc_mote]);
  memset((void *)&FloodingC$PROBABILITY[__nesc_mote], 0, sizeof FloodingC$PROBABILITY[__nesc_mote]);
