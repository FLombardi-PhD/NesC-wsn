...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b67cfbab6b0, const void *arg_0x2b67cfbab988);
#line 776
__extension__ 
#line 793
__extension__ 
...
#line 251
extern double erfc(double arg_0x2b67cfc2d930) __attribute((__nothrow__)) ;
...
unsigned int (*hashfunction)(void *arg_0x2b67cfe57ca8), 
int (*key_eq_fn)(void *arg_0x2b67cfe564e8, void *arg_0x2b67cfe56788));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b67d00e69b0, int arg_0x2b67d00e6c18);
static double RandomUniform(void );
...
# 20 "FloodingC.nc"
nx_uint16_t FloodingC$nodes[1000][150];
nx_uint16_t FloodingC$nodes2[1000][150];
      ...
      if (4 != 0) {
          if (__nesc_ntoh_uint16(rcm->id.data) != TOS_NODE_ID) {
              if (__nesc_ntoh_uint16(FloodingC$nodes[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data) == __nesc_ntoh_uint16(rcm->seq.data)) {
                  ...
                  if (__nesc_ntoh_uint16(FloodingC$nodes2[sim_node()][__nesc_ntoh_uint16(rcm->id.data)].data) < 4) {
                      ...
                      if (FloodingC$AMSend$send(AM_BROADCAST_ADDR, &FloodingC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
                          sim_log_debug(112U, "Inoltro", "Pacchetto inoltrato id=%hhu seq=%hhu message=%hhu\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), __nesc_ntoh_uint16(rcm->message.data));
                        }
                    }
                  else {
#line 105
                    sim_log_debug(113U, "Scarti", "Pacchetto scartato id=%hhu seq=%hhu message=%hhu\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), __nesc_ntoh_uint16(rcm->message.data));
                    }
                }
              else {
#line 107
...
#line 108
                  {
                    ...
                    __nesc_hton_uint16(rcm2->message.data, __nesc_ntoh_uint16(rcm->message.data));
                    if (FloodingC$AMSend$send(AM_BROADCAST_ADDR, &FloodingC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
                        sim_log_debug(115U, "Inoltro", "Pacchetto inoltrato id=%hhu seq=%hhu message=%hhu\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), __nesc_ntoh_uint16(rcm->message.data));
                      }
                  }
                }
            }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b67d04c6438, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x2b67d04c6438) {
#line 67
    case 6:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b67d04c6438, msg, payload, len);
#line 67
      break;
#line 67
    }
...
#line 151
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2b67d05c1020, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2b67d05c1020, addr, msg, len);
#line 69
...
#line 64
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2b67d04c9828, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2b67d04c9828, msg, error);
#line 99
}
#line 99
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b67d04ca020, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b67d04ca020, msg, payload, len);
#line 67
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2b67d05c3e18, message_t * msg, error_t error){
#line 89
  switch (arg_0x2b67d05c3e18) {
#line 89
    case 0U:
#line 89
...
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2b67d05c3e18, msg, error);
#line 89
      break;
#line 89
    }
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b67d01f9020){
#line 64
  switch (arg_0x2b67d01f9020) {
#line 64
...
#line 64
    default:
#line 64
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b67d01f9020);
#line 64
      break;
#line 64
    }
...
#line 64
  ...
  if (TOS_NODE_ID == 1) {
      if (FloodingC$AMSend$send(AM_BROADCAST_ADDR, &FloodingC$packet[sim_node()], sizeof(radio_count_msg_t )) == SUCCESS) {
          sim_log_debug(110U, "Inoltro", "Pacchetto inviato id=%hhu seq=%hhu message=%hhu\n", __nesc_ntoh_uint16(rcm->id.data), __nesc_ntoh_uint16(rcm->seq.data), __nesc_ntoh_uint16(rcm->message.data));
        }
    }
}
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2b67d09bac28){
#line 72
  switch (arg_0x2b67d09bac28) {
#line 72
    case 0U:
#line 72
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2b67d09bac28);
#line 72
      break;
#line 72
    }
...
#line 32
{
  ...
  FloodingC$AMControl$start();
  for (FloodingC$i[sim_node()] = 0; FloodingC$i[sim_node()] < 150; ++FloodingC$i[sim_node()]) {
