...
#line 151
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x408d1730, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x408d1730, addr, msg, len);
#line 69
...
#line 83
{
  ...
  sim_log_debug(113U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(114U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(115U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
      ...
      sim_log_debug(116U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x408d4ca0, message_t * msg, error_t error){
#line 89
  switch (arg_0x408d4ca0) {
#line 89
    case 0U:
#line 89
...
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x408d4ca0, msg, error);
#line 89
      break;
#line 89
    }
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b113a8){
#line 72
  switch (arg_0x40b113a8) {
#line 72
    case 0U:
#line 72
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b113a8);
#line 72
      break;
#line 72
    }
